        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2 sm:gap-3" ref={dropdownRef}>
            ...
            <motion.button
              ...
              className="lg:hidden relative w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 bg-[var(--foreground)]/5 hover:bg-[var(--foreground)]/10 text-[var(--foreground)]/60"
            >
              <FiSearch size={18} />
            </motion.button>
      ...
      <AnimatePresence>
        {mobileSearchOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed inset-x-0 top-0 bg-[var(--background)] z-[1002] p-4 border-b border-[var(--border)] shadow-2xl lg:hidden"
          >
            <div className="flex items-center gap-3">
              <HeaderSearch
                className="lg:hidden !max-w-none !mx-0"
                autoFocus={true}
                onClose={() => setMobileSearchOpen(false)}
              />
              <button
                onClick={() => setMobileSearchOpen(false)}
                className="w-10 h-10 rounded-xl bg-[var(--foreground)]/5 flex items-center justify-center text-[var(--muted)] flex-shrink-0"
              >
                <FiX size={20} />
              </button>
            </div>
