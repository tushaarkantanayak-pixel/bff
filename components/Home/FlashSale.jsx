                        ...
                        {flashSaleData.map((item, index) => (
                            ...
                            >
                                <Link
                                    ...
                                    className="group relative block w-[130px] sm:w-[150px] md:w-[200px] bg-[var(--card)]/40 backdrop-blur-lg border border-white/5 rounded-[1rem] p-1.5 transition-all duration-500 hover:border-amber-500/30 hover:bg-amber-500/[0.04] shadow-lg"
                                >
                                    {/* Badge */}
                                    <div className="absolute top-2 left-2 z-20">
                                        <span className="text-[7px] md:text-[8px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-md bg-amber-500 text-black shadow-lg">
                                            {item.badge}
                                        </span>
                                    </div>
                                    ...
                                    <div className="space-y-0.5 px-0.5">
                                        ...
                                        <h3 className="text-[10px] md:text-[13px] font-black uppercase tracking-tight text-[var(--foreground)] truncate group-hover:text-amber-500 transition-colors">
                                            {item.name}
                                        </h3>

                                        <div className="flex items-center justify-between pt-0.5">
                                            <span className="text-[12px] md:text-[15px] font-black italic text-[var(--foreground)]">
                                                {item.price}
                                            </span>
